...
INSERT INTO `carrito` VALUES (1,18,'admin',1),(2,19,'admin',1),(3,19,'admin',1),(18,19,'pepesanchez',1),(26,17,'miledmin',1),(66,18,'romi25',1),(67,19,'romi25',1);
...
--
-- Table structure for table `petboutiqueapp_direccion`
--

DROP TABLE IF EXISTS `petboutiqueapp_direccion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `petboutiqueapp_direccion` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `petboutiqueapp_direccion_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `petboutiqueapp_direccion`
--

LOCK TABLES `petboutiqueapp_direccion` WRITE;
/*!40000 ALTER TABLE `petboutiqueapp_direccion` DISABLE KEYS */;
INSERT INTO `petboutiqueapp_direccion` VALUES (1,7,'Casa','calle casa 13','miami','5000');
/*!40000 ALTER TABLE `petboutiqueapp_direccion` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-06-29  7:15:47
